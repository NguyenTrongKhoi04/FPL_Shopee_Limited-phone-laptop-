            ...
            <form action="" method="POST" class="rounded p-5 pt-0 start-0 me-5 mt-xxl-5 ">
                ...
                <div class="infor-product-left">
                    <div class="infor-product-left__item">
                        <img src="{{$products['image']}}" id="product-image" alt=""
            ...
            <div class="infor-product-right">
                ...
                <div class="priceandsold">
                    <h4 class="infor-product__right-price-number ps-0 ">
                        <b id="giatien">
                            <del>
                                <p style="font-size: 13px;" id="product-price"></p>
                            </del>
                            <p id="product-price-sc" style="font-size: 25px; color: red;"> </p>
                        </b>
                ...
                <div class="right">
                    <div class="mb-3">
                        ...
                        <select class="form-control w-25  px-3 py-2 m-3" onchange="changeProduct()" id="product-select"
                            aria-label="Default select example">
                            @foreach($products as $index => $pro)
                            <option class="h3" value="{{$index}}" data-image="{{$pro['image']}}"
                                data-sale="{{$pro['valuesale']}}" data-price="{{$pro['price']}}"
                                data-id="{{$pro['detail_product_id']}}">
                                {{$pro['namesize']}}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="float-stat rounded ">
                        ...
                        <div class="align-content-center  d-flex  ">
                            <button type="button" class="material-symbols-outlinedbtn" onclick="handleMinus()"><span
                                    class="material-symbols-outlined">
                                    remove
                                </span></button>
                            <input type="text" class="form-control w-25   mx-1 text-center border-1  " value="1"
                                name="quantity" id="amout">
                            <button type="button" class="material-symbols-outlinedbtn" onclick="handlePlus()"><span
                                    class="material-symbols-outlined">
                                    add
                                </span></button>
                        ...
                        <div class="d-flex mt-3">
                            <input type="text" name="giasanpham" hidden value="" id=""><span
                                class="rounded  infor-product__right-btn-add" style="text-decoration: none;"><i
                                    onclick="AddToCart()" class="fa-solid fa-cart-plus"></i></span>
                            <a href="home.php"
                                class="infor-product__right-btn-buy infor-product__right-btn-buy-link">Mua
                                ngay</a>';
                        </div>
                    </div>
                    </form>
            ...
            <div class="container__ctsp-comment-user">
                <div class="container__ctsp-comment-user-img">
                    <img src="{{BASE_URL.'public/user/assets/img_user/avtgithub.png'}}" alt=""
                        class="container__ctsp-comment-user-image">
                </div>
