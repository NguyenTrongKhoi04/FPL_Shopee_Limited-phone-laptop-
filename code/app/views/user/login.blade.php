                ...
                <div class="auth-form__container">
                    ...
                    <div class="auth-form__form">
                        <div class="auth-form__group">
                            ...
                            <span class="auth-form__form-masage h4 text-danger ">
                    ...
                    <div class="auth-form__controls">
                        <a href="{{route('product/')}}" class="btn align-content-center bg-light   auth-form__controls-back btn--nomals">TRỞ VỀ</a>
